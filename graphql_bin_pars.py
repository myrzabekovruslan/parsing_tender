...
for i in include_bin:
    ...
    bin_id.append(r.json().get('data').get('Subjects')[0].get('pid'))
...
try:
    ...
    with open(f"bin_contracts.csv", mode="w", encoding='utf-8') as w_file:
